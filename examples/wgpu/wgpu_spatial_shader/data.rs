...
// Define normals for the cube (one normal per vertex, but all vertices on the same face have the same normal)
pub const NORMALS: [Normal; 24] = [
    // Front face (z = 1.0) - normal points in +z direction
    Normal { normal: (0.0, 0.0, 1.0) },
    Normal { normal: (0.0, 0.0, 1.0) },
    Normal { normal: (0.0, 0.0, 1.0) },
    Normal { normal: (0.0, 0.0, 1.0) },
    
    // Back face (z = -1.0) - normal points in -z direction
    Normal { normal: (0.0, 0.0, -1.0) },
    Normal { normal: (0.0, 0.0, -1.0) },
    Normal { normal: (0.0, 0.0, -1.0) },
    Normal { normal: (0.0, 0.0, -1.0) },
    
    // Top face (y = 1.0) - normal points in +y direction
    Normal { normal: (0.0, 1.0, 0.0) },
    Normal { normal: (0.0, 1.0, 0.0) },
    Normal { normal: (0.0, 1.0, 0.0) },
    Normal { normal: (0.0, 1.0, 0.0) },
    
    // Bottom face (y = -1.0) - normal points in -y direction
    Normal { normal: (0.0, -1.0, 0.0) },
    Normal { normal: (0.0, -1.0, 0.0) },
    Normal { normal: (0.0, -1.0, 0.0) },
    Normal { normal: (0.0, -1.0, 0.0) },
    
    // Right face (x = 1.0) - normal points in +x direction
    Normal { normal: (1.0, 0.0, 0.0) },
    Normal { normal: (1.0, 0.0, 0.0) },
    Normal { normal: (1.0, 0.0, 0.0) },
    Normal { normal: (1.0, 0.0, 0.0) },
    
    // Left face (x = -1.0) - normal points in -x direction
    Normal { normal: (-1.0, 0.0, 0.0) },
    Normal { normal: (-1.0, 0.0, 0.0) },
    Normal { normal: (-1.0, 0.0, 0.0) },
    Normal { normal: (-1.0, 0.0, 0.0) },
...
// Define indices for drawing the cube faces as triangles
